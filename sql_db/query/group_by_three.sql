...
select count(so_id), max(track), min(track), avg(track), album
from all_song_album
group by album
having avg(track) > 2
order by album desc;
...
/*
+--------------+------------+------------+------------+-----------------------------------+
| count(so_id) | max(track) | min(track) | avg(track) | album                             |
+--------------+------------+------------+------------+-----------------------------------+
|            1 |          4 |          4 |     4.0000 | 선의의 경쟁 OST                   |
|           10 |         10 |          1 |     5.5000 | Visionary Vision <Performante>    |
|            7 |          7 |          1 |     4.0000 | tripleS_hatch!_SecretHimitsuBimil |
|            6 |          6 |          1 |     3.5000 | msnz_Beyond_Beauty                |
|            8 |          8 |          1 |     4.5000 | LOVElution <ↀ>                    |
|            7 |          7 |          1 |     4.0000 | love_and_pop_pt1                  |
|            8 |          8 |          1 |     4.5000 | EVOLution <⟡>                     |
|            7 |          7 |          1 |     4.0000 | ASSEMBLE                          |
|            6 |          6 |          1 |     3.5000 | Acid Angel from Asia <ACCESS>     |
|           14 |         14 |          1 |     7.5000 | 4study4work4inst_Vol.3            |
|           18 |         18 |          1 |     9.5000 | 4study4work4inst Vol.2            |
|           31 |         31 |          1 |    16.0000 | 4study4work4inst Vol.1            |
|           10 |         10 |          1 |     5.5000 | <ASSEMBLE25>                      |
|            6 |          6 |          1 |     3.5000 | +(KR)ystal Eyes <AESTHETIC>       |
|           10 |         10 |          1 |     5.5000 | 〈ASSEMBLE24〉                    |
+--------------+------------+------------+------------+-----------------------------------+
*/
