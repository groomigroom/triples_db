...
| album                                                          |
+----------------------------------------------------------------+
| Baby Flower Japanese Version                                   |
| love_and_pop_pt1                                               |
| Tokimetique                                                    |
| 4study4work4inst_Vol.3                                         |
| msnz_Beyond_Beauty                                             |
| tripleS_hatch!_SecretHimitsuBimil                              |
| tripleS hatch! <Password>                                      |
| Pink Power(잔망루피, tripleS (트리플에스))                     |
| <ASSEMBLE25>                                                   |
| Girls Never Die (Japanese Version)                             |
| Rising (Japanese Version)                                      |
| 선의의 경쟁 OST                                                |
| 선의의경쟁 OST Part.4                                          |
| 4study4work4inst Vol.2                                         |
| Dreaming (골 때리는 그녀들 X tripleS (트리플에스))             |
...
select substring(album, 1, 3) sub_al
from all_song_album
where so_id > 20
group by substring(album, 1, 3)
order by 1;
