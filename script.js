...
let three_one_btn = document.querySelector(".three_one_btn");
let three_one_table = document.querySelector(".three_one_table");

three_one_btn.addEventListener("click", () => {
    three_one_btn.classList.toggle("on");
    three_one_table.classList.toggle("on");
});
